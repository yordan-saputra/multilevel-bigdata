\section{The split-sample approach}
    ...
    \begin{frame}
        \frametitle{\insertsection\ $-$ \insertsubsection}
        \begin{itemize}
            \item Shown in panel (d) of Figure~\ref{fig:1}, dataset with large $n$ is partitioned similarly to dependent subsamples, but association between observations is accounted for by letting the subsamples overlap
